...
class AmplifyRequireNewPassword {
    ...
    async completeNewPassword(event) {
        ...
        this.loading = true;
        try {
            const user = await Auth.Auth.completeNewPassword(this.user, this.password, this.requiredAttributes);
...
class AmplifySignIn {
    ...
    render() {
        return (index.h("amplify-form-section", { headerText: this.headerText, handleSubmit: this.handleSubmit, testDataPrefix: 'sign-in' }, index.h("amplify-federated-buttons", { handleAuthStateChange: this.handleAuthStateChange, federated: this.federated }), !core.isEmpty(this.federated) && index.h("amplify-strike", null, "or"), index.h("amplify-auth-fields", { formFields: this.newFormFields }), index.h("div", { slot: "amplify-form-section-footer", class: "sign-in-form-footer" }, index.h("slot", { name: "footer" }, index.h("slot", { name: "secondary-footer-content" }, index.h("span", null, core.I18n.get(Translations.Translations.NO_ACCOUNT_TEXT), ' ', index.h("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(authTypes.AuthState.SignUp), "data-test": "sign-in-create-account-link" }, core.I18n.get(Translations.Translations.CREATE_ACCOUNT_TEXT)))), index.h("slot", { name: "primary-footer-content" }, index.h("amplify-button", { type: "submit", disabled: this.loading, "data-test": "sign-in-sign-in-button" }, index.h("amplify-loading-spinner", { style: { display: this.loading ? 'initial' : 'none' } }), index.h("span", { style: { display: this.loading ? 'none' : 'initial' } }, this.submitButtonText)))))));
    }
    static get watchers() { return {
        "formFields": ["formFieldsHandler"]
    }; }
